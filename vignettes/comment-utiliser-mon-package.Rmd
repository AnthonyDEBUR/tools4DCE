...
Calcul le percentile selon les règles DCE.
Dans l'exemple ci-dessous le percentile 90 correspond au 18ème rang sur 20 valeurs (rang = arrondi((20 x 0.9) + 0.5))
...
```{r}
import_hub_eau_staq_hbio(liste_stations=c("03174000", "04216000"))
```
...
str(import_hub_eau_staq_hbio(emprise=Vilaine, an_debut=2018, an_fin=2018, indice=c("poi")))
...
```{r}
str(import_hub_eau_indices_hbio(liste_stations=c("03174000", "04216000"), indice=c("mphy")))
```
