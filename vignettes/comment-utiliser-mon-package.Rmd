...
# synthese<-daply(donnees, .(Parametre), function(x){table_distribution(x,seuil=seuils)})
# do.call("bind_rows", apply(donnees, 1, function(x){table_distribution(x$,seuil=seuils)}))
# 
# ggplot(donnees, aes(x=nb, y=Parametre, fill=categorie, alpha=CdRqAna))+ 
